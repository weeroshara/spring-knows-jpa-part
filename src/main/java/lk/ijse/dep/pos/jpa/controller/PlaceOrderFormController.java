package lk.ijse.dep.pos.jpa.controller;

import lk.ijse.dep.pos.jpa.AppInitializer;
...
import lk.ijse.dep.pos.jpa.util.*;
...
public class PlaceOrderFormController {
    ...
    private OrderBO orderBO = AppInitializer.getContext().getBean(OrderBO.class);
    private ItemBO itemBO = AppInitializer.getContext().getBean(ItemBO.class);
    private CustomerBO customerBO = AppInitializer.getContext().getBean(CustomerBO.class);
